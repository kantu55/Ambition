...
namespace Ambition.UI
{
    ...
    public abstract class DetailPanelController<T> : MonoBehaviour where T : class
    {
        ...
        [SerializeField] protected Button itemButtonPrefab;
        [SerializeField] protected Button backButton;

        [Header("Detail Panel Components")]
        [SerializeField] protected GameObject detailPanelRoot;
        [SerializeField] protected TextMeshProUGUI detailNameText;
        [SerializeField] protected TextMeshProUGUI detailCostText;
        [SerializeField] protected TextMeshProUGUI detailEffectText;
        [SerializeField] protected Image detailImage;
